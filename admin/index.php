...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/bg-gpt2.jpg);">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3" style="margin-top:4%">
						<h1 class="text-center text-bold text-black mt-4x bg-white">Hostel Management System</h1>
